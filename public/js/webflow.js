...
Webflow.require('ix').init([
  {"slug":"no-show-on-load","name":"No Show on Load","value":{"style":{"opacity":0},"triggers":[]}},
  {"slug":"show-menu","name":"Show Menu","value":{"style":{},"triggers":[{"type":"hover","selector":".list-item-menu","descend":true,"stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0"}],"stepsB":[{"display":"block","opacity":0,"transition":"opacity 500ms ease 0"}]}]}}
]);
